{{-- chart asset section --}}
<div class="w-full max-w-[1400px] mx-auto mt-15 px-4">
    <div class="flex flex-col lg:flex-row gap-6">
        <div class="flex-1 border border-[#E4E9EC] rounded-xl p-4 md:p-6 shadow-sm bg-white overflow-hidden">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-4">
                ...
                <div class="flex gap-1 bg-[#FAFAFA] border-[#E4E9EC] border rounded-lg p-1 self-start sm:self-auto overflow-x-auto">
                    <button onclick="setActive(this)" class="timeframe-btn whitespace-nowrap px-3 py-1 text-[13px] rounded-md bg-[#E6EFFB] text-[#3366CC] font-medium transition-all">01 m</button>
                    <button onclick="setActive(this)" class="timeframe-btn whitespace-nowrap px-3 py-1 text-[13px] rounded-md text-gray-500 font-medium hover:bg-white hover:text-gray-800 transition-all">15m</button>
                    <button onclick="setActive(this)" class="timeframe-btn whitespace-nowrap px-3 py-1 text-[13px] rounded-md text-gray-500 font-medium hover:bg-white hover:text-gray-800 transition-all">01 h</button>
                    <button onclick="setActive(this)" class="timeframe-btn whitespace-nowrap px-3 py-1 text-[13px] rounded-md text-gray-500 font-medium hover:bg-white hover:text-gray-800 transition-all">01 day</button>
                </div>
            </div>
            ...
            <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4 mb-4">
                ...
                <div class="flex flex-wrap items-center gap-4 text-[14px] font-medium text-[#000000]">
            ...
            <div class="flex items-stretch gap-1 min-h-[300px]">
            ...
            <div class="mt-4 flex flex-col items-center seoge-font">
                ...
                <div class="grid grid-cols-2 md:flex md:flex-wrap justify-center gap-8 text-[15px] text-[#333333] font-regular tracking-wide">
        ...
        <div class="w-full lg:w-80 border border-[#E4E9EC] rounded-xl p-4 shadow-sm poppins-font">
